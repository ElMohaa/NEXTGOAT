package org.example.next_goat.Controllers.Recovery;
...
public class ViewKneeController {
    ...
    private void loadVideo() {
        String videoPath = getClass().getResource("/VIDEOS/recuperacion" + skillNumber + ".mp4").toExternalForm();
