...
public class SoleRoleStopControll {
    ...
    public void initialize() {
        ...
        String videoPath = getClass().getResource("/VIDEOS/SoleRoleStopOriginal.mp4").toExternalForm(); // Cambia esta ruta a la ubicación de tu video
    ...
    private void back(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/Coach1BallControl.fxml"));
