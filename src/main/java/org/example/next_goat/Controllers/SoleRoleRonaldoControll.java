...
public class SoleRoleRonaldoControll {
    @FXML
    ...
    public void initialize() {
        ...
        String videoPath = getClass().getResource("/VIDEOS/soleRonaldo.mp4").toExternalForm(); // Cambia esta ruta a la ubicación de tu video
