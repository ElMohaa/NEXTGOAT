...
public class GrasscutterControll {
    @FXML
    ...
    public void initialize() {
        ...
        String videoPath = getClass().getResource("/VIDEOS/grasscutter.mp4").toExternalForm(); // Cambia esta ruta a la ubicación de tu video
