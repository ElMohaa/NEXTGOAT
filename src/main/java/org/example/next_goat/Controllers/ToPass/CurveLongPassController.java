package org.example.next_goat.Controllers.ToPass;
...
public class CurveLongPassController {
    ...
    public void initialize() {
        ...
        String videoPath = getClass().getResource("/VIDEOS/curveLongPass.mp4").toExternalForm(); // Cambia esta ruta a la ubicación de tu video
