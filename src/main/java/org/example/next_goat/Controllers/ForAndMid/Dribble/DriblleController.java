...
public class DriblleController {
    @FXML
    private MediaView mediaView;

    private int skillNumber; // Almacena el número de habilidad

    public void setDriblleNumber(int skillNumber) {
        this.skillNumber = skillNumber;
        loadVideo();
    }

    private void loadVideo() {
        String videoPath = getClass().getResource("/VIDEOS/Driblle" + skillNumber + ".mp4").toExternalForm();
