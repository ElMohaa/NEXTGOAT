...
public class Coach2BallControll {
    ...
    private void buttonSoleDrag(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SoleRoleDrag.fxml"));
    ...
    private void buttoncr(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SkillCR7.fxml"));
            Parent laLigaView = loader.load();
    ...
    private void buttonEasy(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SkillEasy.fxml"));
            Parent laLigaView = loader.load();
