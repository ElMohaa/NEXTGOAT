...
public class Coach1BallControll {
    ...
    private void buttonSoleRole(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SoleRoleStop.fxml"));
            Parent laLigaView = loader.load();
    ...
    private void buttonRonaldo(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SoleRoleRonaldo.fxml"));
            Parent laLigaView = loader.load();
    ...
    private void buttonOut(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/SoleDragOutside.fxml"));
            Parent laLigaView = loader.load();
    ...
    private void buttonSkill(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ForwardAndMid/DRIBLLES/Skill.fxml"));
            Parent laLigaView = loader.load();
