...
public class ViewMobility {
    ...
    public void setMobiNumber(int skillNumber) {
        this.skillNumber = skillNumber;
        loadVideo();
    }

    private void loadVideo() {
        String videoPath = getClass().getResource("/VIDEOS/movilidad" + skillNumber + ".mp4").toExternalForm();
